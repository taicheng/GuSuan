//
//  SCImageCropperViewController.m
//  VPolor
//
...
@interface SCImageCropperViewController ()
...
@implementation SCImageCropperViewController
...
- (void)initControlBtn
{
    ...
    bottomView.backgroundColor = [UIColor colorWithWhite:0 alpha:0.5f];
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(kScreenWidth - 100.0f, 0, 100, 50)];
